...
const Assets = {
	...
	LaTeX: asset('latex-hummingbird.svg'),
	// Core Competency icons
	CoreGameProduction: asset('Project Scheduling.svg', 'Project Scheduling_Dark.svg'),
	CoreAgileScrum: asset('Scrum.svg', 'Scrum_Dark.svg'),
	CoreTeamLeadership: asset('Leadership.svg', 'Leadership_Dark.svg'),
	CoreRiskManagement: asset('Risk Management.svg', 'Risk Management_Dark.svg'),
	CoreMilestonePlanning: asset('Analysis.svg', 'Analysis_Dark.svg'),
	CoreStakeholderComm: asset('Stakeholder Faciliataion.svg', 'Stakeholder Faciliataion_Dark.svg'),
	CoreProductionPipeline: asset('Documentation.svg', 'Documentation_Dark.svg'),
	CoreBudgetResource: asset('Resource Alllocation.svg', 'Resource Alllocation_Dark.svg'),
	CorePresentation: asset('Presentation.svg', 'Presentation_Dark.svg'),
	CoreProblemSolving: asset('Problem Solving.svg', 'Problem Solving_Dark.svg'),
	CoreTesting: asset('Testing.svg', 'Testing_Dark.svg'),
