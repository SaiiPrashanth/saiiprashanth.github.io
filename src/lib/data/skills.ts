...
const items = [
	defineSkill({
		slug: 'cpp',
		color: 'blue',
		description: 'C++ (pronounced "C plus plus") is a high-level, general-purpose programming language created by Danish computer scientist Bjarne Stroustrup at Bell Labs. First released in 1985 as an extension of C, it has expanded significantly over time; as of 1997, C++ has object-oriented, generic, and functional features, in addition to facilities for low-level memory manipulation.\n\nFun fact: C++ was originally named "C with Classes" in 1979! The name C++ was coined in 1983, with "++" being the increment operator in C, suggesting it\'s an enhanced version of C. It is almost always implemented as a compiled language, and many vendors provide C++ compilers, including GCC, LLVM/Clang, Microsoft Visual C++, Intel, and IBM. The latest standard, C++23, was approved in 2023.\n\nC++ powers some of the world\'s most performance-critical software including Adobe Photoshop, MySQL, MongoDB, and most AAA game engines like Unreal Engine. It\'s fascinating that despite being over 35 years old, C++ remains one of the top 5 most popular programming languages, proving that raw performance and control still matter in modern computing.',
		logo: Assets.Cpp,
		name: 'C++',
		category: 'pro-lang'
	}),
	...
	defineSkill({
		slug: '3dsmax',
		color: 'teal',
		description: 'Autodesk 3ds Max (formerly 3D Studio and 3D Studio Max) is a professional 3D computer graphics program for making 3D animations, models, games, and images. The story begins in 1990 when Gary Yost founded the Yost Group and created 3D Studio for DOS - yes, DOS! It ran on those old text-based computers and became hugely popular despite limited hardware. When Windows 95 arrived, the Yost Group rewrote it as 3D Studio Max in 1996. Autodesk acquired it in 1999 and rebranded it as 3ds Max. Developed and produced by Autodesk Media and Entertainment, it has been an industry standard for game asset creation, architectural visualization, and visual effects for nearly 30 years. 3ds Max features a robust polygonal modeling toolset (Edit Poly modifier is legendary), powerful rendering capabilities through Arnold (acquired by Autodesk), V-Ray (third-party but industry standard), comprehensive animation and rigging tools (Character Animation Toolkit, Biped, CAT rigs), and extensive plugin architecture (hundreds of plugins available). Fun fact: 3ds Max\'s modifier stack is one of its most powerful features - it allows non-destructive editing by stacking modifiers, and you can animate any parameter! 3ds Max is particularly dominant in game development (used for Gears of War, Mass Effect, countless AAA titles), architecture and product visualization (arch-viz artists swear by it), and was heavily used in films like Avatar and Iron Man. Its scripting language MaxScript allows infinite customization. 3ds Max 2024 introduced Retopology Tools and improved USD support!',
	...
	defineSkill({
		slug: 'js',
		color: 'yellow',
		description: 'JavaScript (JS) is a lightweight, interpreted (or just-in-time compiled) programming language with first-class functions. While it is most well-known as the scripting language for Web pages, many non-browser environments also use it, such as Node.js, Apache CouchDB, and Adobe Acrobat. JavaScript is a prototype-based, multi-paradigm, single-threaded, dynamic language, supporting object-oriented, imperative, and declarative (e.g. functional programming) styles.\n\nHere\'s a wild fact: JavaScript was created by Brendan Eich in just 10 days in May 1995 while working at Netscape! Originally named "Mocha", then "LiveScript", it was renamed "JavaScript" as a marketing move to ride on Java\'s popularity, despite having almost nothing in common with Java.\n\nThat\'s impressive and all, but you know what\'s also impressive? Shooting yourself in the foot while writing some code with this language: \'11\' + 1 equals \'111\' (string concatenation), but \'11\' - 1 equals 10 (numeric subtraction) - why??? Despite its quirks, JavaScript has become the most widely-used programming language, with 98% of websites using it. The ECMAScript standard (ES2024 is the latest) governs its evolution, and it now powers full-stack development through Node.js, mobile apps via React Native, and even desktop apps with Electron!',
	...
	defineSkill({
		slug: 'opengl',
		color: 'blue',
		description: 'OpenGL (Open Graphics Library) is a cross-language, cross-platform application programming interface (API) for rendering 2D and 3D vector graphics. The API is typically used to interact with a graphics processing unit (GPU) to achieve hardware-accelerated rendering. First released in 1992 by Silicon Graphics, Inc. (SGI), OpenGL was revolutionary - before OpenGL, graphics programming was hardware-specific and proprietary. Fun history: OpenGL emerged from SGI\'s IRIS GL (used in their expensive graphics workstations costing $100,000+), but was redesigned to be open and hardware-agnostic. OpenGL has become one of the most widely adopted graphics APIs, supported on Windows, macOS, Linux, and mobile platforms through OpenGL ES (used in iOS and Android). OpenGL provides functions for drawing complex 3D scenes from simple primitives (points, lines, triangles), including features for texturing, lighting, shading (via GLSL), transformations, and much more. Here\'s impressive: OpenGL\'s specification is managed by the Khronos Group (formed in 2006), which also manages Vulkan (OpenGL\'s modern successor), WebGL (OpenGL for web browsers), and other graphics standards. OpenGL has powered countless applications: Minecraft (Java Edition), Blender, Google Earth, medical imaging software, scientific visualizations, and most pre-2015 games. Fun fact: OpenGL 1.0 had 257 functions; OpenGL 4.6 (2017, latest version) has over 500! Despite Vulkan\'s emergence, OpenGL remains widely used due to its simpler API and massive ecosystem.',
		logo: Assets.OpenGL,
		name: 'OpenGL',
		category: 'pro-lang'
	}),
