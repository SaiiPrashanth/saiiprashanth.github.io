...
const items: Array<Experience> = [
	...
	},
	{
		...
		location: 'Coimbatore, TN',
		period: { from: new Date(2022, 5, 1), to: new Date(2025, 7, 1) },
	...
	},
	{
		...
		type: 'Education',
		location: 'Bengaluru',
		period: { from: new Date(2022, 7, 1), to: new Date(2025, 4, 1) },
	...
	},
	{
		...
		type: 'Education',
		location: 'Coimbatore',
		period: { from: new Date(2020, 5, 1), to: new Date(2022, 4, 1) },
