...
const items: Array<GalleryItem> = [
	// --- GAME ---
	{
		...
		screenshots: [
			{ src: `${base}/gallery/BB_1.webp`, label: 'Bumble Bee Project' }
		]
	},
	{
		slug: 'hungry-kirby',
		...
		screenshots: [
			{ src: `${base}/gallery/HK_1.webp`, label: 'Hungry Kirby Gameplay' }
		]
	},
	{
		slug: 'astron',
	...
	},
	{
		...
		screenshots: [
			{ src: `${base}/gallery/BT1.webp`, label: 'Boating Through Gameplay' }
		]
	},
	{
		slug: 'neko-gambit',
		...
		image: `${base}/gallery/Neko_Gambit_img_1.webp`,
		...
		screenshots: [
			{ src: `${base}/gallery/Neko_Gambit_img_1.webp`, label: 'Neko Gambit Gameplay' }
		]
	},
	{
		slug: 'cubeology',
