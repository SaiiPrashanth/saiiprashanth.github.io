...
const items: Array<GalleryItem> = [
	...
	},
	{
		slug: 'spline-tool',
		name: 'Spline Tool',
		description: 'A Unity Editor spline tool for scattering and aligning meshes along a user-defined path. Ideal for quickly laying out repeated scene elements like cobblestone paths, fence lines, bridge planks, and road barriers without manual placement.',
		shortDescription: 'Unity spline tool for path-based mesh arrangement and scattering.',
	...
	},
	{
		...
		description: 'A Unity Editor tool for texture workflow automation. Supports channel packing with custom R/G/B/A source remapping, texture atlas generation, and a bulk import setting editor that lets you update compression, mip, and wrap settings across multiple textures in one pass.',
		shortDescription: 'Unity tool for channel packing, atlasing, and bulk import edits.',
	...
	},
	{
		slug: 'car-rig',
		name: 'Car Rig',
		description: 'A simple vehicle rig created in Maya. Includes a centralised body suspension system, rigged doors and hood with open/close controls, a front-axle steering controller for wheel turn, and a master controller that rotates all four wheels simultaneously.',
		shortDescription: 'Maya car rig with suspension, doors, hood, and wheel controls.',
